...
public class FileExplorerActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dileex);
        //액션바 숨김
        getActionBar().hide();
        ...
        fileExplorerItem.setDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.outline_folder_open_black_48));
